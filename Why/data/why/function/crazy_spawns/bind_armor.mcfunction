...
execute at @s if data entity @s {equipment:{head:{}}} on attacker if data entity @s {equipment:{head:{}}} run summon item ~ ~1 ~ {Tags:["crazyHelmet"],Item:{id:"minecraft:firework_star",count:1,components:{"minecraft:custom_name":"Armor Placeholder","minecraft:lore":["If you are holding this item, ","something is really wrong with my code..."]}}}
execute at @s if data entity @s {equipment:{chest:{}}} on attacker if data entity @s {equipment:{chest:{}}} run summon item ~ ~1 ~ {Tags:["crazyChestplate"],Item:{id:"minecraft:firework_star",count:1,components:{"minecraft:custom_name":"Armor Placeholder","minecraft:lore":["If you are holding this item, ","something is really wrong with my code..."]}}}
execute at @s if data entity @s {equipment:{legs:{}}} on attacker if data entity @s {equipment:{legs:{}}} run summon item ~ ~1 ~ {Tags:["crazyLeggings"],Item:{id:"minecraft:firework_star",count:1,components:{"minecraft:custom_name":"Armor Placeholder","minecraft:lore":["If you are holding this item, ","something is really wrong with my code..."]}}}
execute at @s if data entity @s {equipment:{feet:{}}} on attacker if data entity @s {equipment:{feet:{}}} run summon item ~ ~1 ~ {Tags:["crazyBoots"],Item:{id:"minecraft:firework_star",count:1,components:{"minecraft:custom_name":"Armor Placeholder","minecraft:lore":["If you are holding this item, ","something is really wrong with my code..."]}}}
