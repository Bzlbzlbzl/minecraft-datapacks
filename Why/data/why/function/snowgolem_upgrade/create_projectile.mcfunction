...
#Slow potion
execute if score %proj snowgolem_upgrade matches 2 at @s run summon splash_potion ~ ~ ~ {Tags:["suProj","suSpawned"],Item:{id:"minecraft:splash_potion",count:1,components:{"minecraft:potion_contents":{potion:"minecraft:slowness"}}}}
#Weakness potion
execute if score %proj snowgolem_upgrade matches 3 at @s run summon splash_potion ~ ~ ~ {Tags:["suProj","suSpawned"],Item:{id:"minecraft:splash_potion",count:1,components:{"minecraft:potion_contents":{potion:"minecraft:weakness"}}}}
#Heal/harm potion
execute if score %proj snowgolem_upgrade matches 4 run scoreboard players set %not_undead snowgolem_upgrade 0
execute if score %proj snowgolem_upgrade matches 4 as @e[type=snow_golem,limit=1,sort=nearest] on target if entity @s[type=!#minecraft:undead] run scoreboard players set %not_undead snowgolem_upgrade 1
execute if score %proj snowgolem_upgrade matches 4 if score %not_undead snowgolem_upgrade matches 1 at @s run summon splash_potion ~ ~ ~ {Tags:["suProj","suSpawned"],Item:{id:"minecraft:splash_potion",count:1,components:{"minecraft:potion_contents":{potion:"minecraft:harming"}}}}
execute if score %proj snowgolem_upgrade matches 4 if score %not_undead snowgolem_upgrade matches 0 at @s run summon splash_potion ~ ~ ~ {Tags:["suProj","suSpawned"],Item:{id:"minecraft:splash_potion",count:1,components:{"minecraft:potion_contents":{potion:"minecraft:healing"}}}}
#Arrow
...
#Ghast fireball
execute if score %proj snowgolem_upgrade matches 13 at @s run summon fireball ~ ~ ~ {ExplosionPower:1b,Tags:["suProj","suSpawned"]}
#Dragon fireball
...
execute if score %proj snowgolem_upgrade matches 14 as @e[type=snow_golem,limit=1,sort=nearest] on target if entity @s[type=!#minecraft:undead] run scoreboard players set %not_undead snowgolem_upgrade 1
...
execute if score %proj snowgolem_upgrade matches 14 if score %not_undead snowgolem_upgrade matches 1 if score %dragon snowgolem_upgrade matches 0 at @s run summon fireball ~ ~ ~ {ExplosionPower:1b,Tags:["suProj","suSpawned"]}
execute if score %proj snowgolem_upgrade matches 14 if score %not_undead snowgolem_upgrade matches 0 at @s run summon fireball ~ ~ ~ {ExplosionPower:1b,Tags:["suProj","suSpawned"]}
#Wither skull
...
execute if score %proj snowgolem_upgrade matches 12..15 store result entity @e[tag=suSpawned,limit=1] Motion[0] double 0.0015 run scoreboard players get %x_dir snowgolem_upgrade
# y power
...
execute if score %proj snowgolem_upgrade matches 12..15 store result entity @e[tag=suSpawned,limit=1] Motion[1] double 0.0015 run scoreboard players get %y_dir snowgolem_upgrade
# z power
...
execute if score %proj snowgolem_upgrade matches 12..15 store result entity @e[tag=suSpawned,limit=1] Motion[2] double 0.0015 run scoreboard players get %z_dir snowgolem_upgrade
