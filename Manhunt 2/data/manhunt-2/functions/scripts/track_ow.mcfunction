...
execute at @a[tag=manhuntRunner,nbt={Dimension:"minecraft:overworld"},limit=1,sort=nearest] run summon armor_stand ~ ~ ~ {Tags:["manhuntMarkerOW"],Marker:1b,Invisible:1b,Silent:1b}