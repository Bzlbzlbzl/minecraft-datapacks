...
execute as @a[tag=!manhuntRunner,nbt={SelectedItem:{id:"minecraft:compass"},Dimension:"minecraft:overworld"}] at @s if entity @e[tag=manhuntMarkerOW] if score %delay manhunt_delay matches 0 facing entity @e[tag=manhuntMarkerOW,limit=1,sort=nearest] eyes positioned ~ ~0.9 ~ rotated ~ 0 run function manhunt-2:scripts/point
execute as @a[tag=!manhuntRunner,nbt={Inventory:[{Slot:-106b, id:"minecraft:compass"}],Dimension:"minecraft:overworld"}] at @s if entity @e[tag=manhuntMarkerOW] if score %delay manhunt_delay matches 6 facing entity @e[tag=manhuntMarkerOW,limit=1,sort=nearest] eyes positioned ~ ~0.9 ~ rotated ~ 0 run function manhunt-2:scripts/point
execute as @a[tag=!manhuntRunner,nbt={SelectedItem:{id:"minecraft:compass"},Dimension:"minecraft:the_nether"}] at @s if entity @e[tag=manhuntMarkerN] if score %delay manhunt_delay matches 0 facing entity @e[tag=manhuntMarkerN,limit=1,sort=nearest] eyes positioned ~ ~0.9 ~ rotated ~ 0 run function manhunt-2:scripts/point
