...
execute if entity @s[type=minecraft:armor_stand] as @e[tag=tpParticle] at @s run function p-prot:scripts/stand_circle
execute if entity @s[type=!minecraft:player,type=!minecraft:armor_stand] as @e[tag=tpParticle] at @s run function p-prot:scripts/mob_circle
