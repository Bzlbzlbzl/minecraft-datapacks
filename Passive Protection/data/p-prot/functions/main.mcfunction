...
execute as @a[team=p-prot,gamemode=!spectator,scores={p_sneak=40}] at @s as @e[type=cow,tag=pCapturing,limit=1,sort=nearest] run data merge entity @s {CustomNameVisible:1b,CustomName:'{"text":"Cow Protector","color":"green","bold":true}',ActiveEffects:[{Id:10b,Amplifier:1b,Duration:2147483647}],Attributes:[{Name:generic.armor,Base:12}],Team:"p-prot",Tags:["pProt"]}
execute as @a[team=p-prot,gamemode=!spectator,scores={p_sneak=40}] at @s as @e[type=pig,tag=pCapturing,limit=1,sort=nearest] run data merge entity @s {Fire:1000000,CustomNameVisible:1b,Team:"p-prot",Tags:["pProt"],CustomName:'{"text":"Bacon Protector","color":"green","bold":true}',ActiveEffects:[{Id:10b,Amplifier:1b,Duration:2147483647,ShowParticles:1b},{Id:12b,Amplifier:0b,Duration:2147483647,ShowParticles:1b}],Attributes:[{Name:generic.armor,Base:18},{Name:generic.armor_toughness,Base:3}]}
...
#Enters pAgressive mode (all); summons a pAI vindicator for all pProt pPassive cows within 18 blocks of an enemy player; red cow name
...
execute as @e[type=pig,tag=pProt,tag=pPassive] at @s if entity @a[team=!p-prot,distance=..18,gamemode=!spectator] run summon zombie ~ ~ ~ {Silent:1b,Invulnerable:1b,Team:"p-prot",PersistenceRequired:1b,CanPickUpLoot:0b,IsBaby:1b,CanBreakDoors:0b,Tags:["pAI"],CustomName:'{"text":"Bacon Protector","color":"red","bold":true}',HandItems:[{id:"minecraft:stone_button",Count:1b,tag:{HideFlags:1,Enchantments:[{id:"minecraft:fire_aspect",lvl:20s}]}},{}],ActiveEffects:[{Id:14b,Amplifier:0b,Duration:2147483647,ShowParticles:0b}],Attributes:[{Name:generic.follow_range,Base:20},{Name:generic.knockback_resistance,Base:1},{Name:generic.movement_speed,Base:0.15},{Name:generic.attack_damage,Base:2},{Name:generic.attack_knockback,Base:2}]}
