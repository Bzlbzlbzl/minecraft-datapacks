...
execute at @e[type=item,tag=returningBook] run particle minecraft:large_smoke ~ ~ ~ 0.3 0.3 0.3 0.1 20
execute at @e[type=item,tag=returningBook] run particle minecraft:smoke ~ ~ ~ 0.1 0.1 0.1 0.15 10
execute at @e[type=item,tag=returningBook] run particle minecraft:raid_omen ~ ~1 ~ 0.2 0.3 0.2 1000 1
execute at @e[type=item,tag=returningBook] if predicate powers:50_chance run particle minecraft:raid_omen ~ ~1 ~ 0.2 0.3 0.2 1000 1
execute at @e[type=item,tag=returningBook] if predicate powers:50_chance run particle minecraft:raid_omen ~ ~1 ~ 0.2 0.3 0.2 1000 1
