...
execute as @e[tag=vsvVectorTip,tag=vsvSpawned] run scoreboard players set @s value 10
...
execute as @e[tag=vsvVectorTail,tag=vsvSpawned] run scoreboard players set @s value 10
