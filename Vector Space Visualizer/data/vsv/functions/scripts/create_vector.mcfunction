...
summon block_display ~ ~ ~ {Tags:["vsvVectorTip","vsvSpawned"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[-0.4f,-0.4f,-0.4f],scale:[0.8f,0.8f,0.8f]},block_state:{Name:"minecraft:orange_concrete"}}
execute as @e[tag=vsvVectorTip,tag=vsvSpawned] at @s run tp @s ~ ~ ~ facing entity @e[type=armor_stand,tag=vsvOrigin,limit=1] feet
execute as @e[tag=vsvVectorTip,tag=vsvSpawned] run function vsv:scripts/assign_next_id
...
execute as @e[tag=vsvVectorTail,tag=vsvSpawned] at @s run tp @s ~ ~ ~ facing entity @e[tag=vsvVectorTip,tag=vsvSpawned,limit=1] feet
