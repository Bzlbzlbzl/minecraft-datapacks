# Creates backwards vector recursively at a distance
...
execute if score %dist values matches 0.. positioned ^ ^ ^-1 run function vsv:scripts/vector/create_backwards_vector
