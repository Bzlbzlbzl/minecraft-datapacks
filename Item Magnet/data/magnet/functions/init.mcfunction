...
scoreboard objectives add magnet_z dummy
scoreboard objectives add magnet_dx dummy
scoreboard objectives add magnet_dy dummy
scoreboard objectives add magnet_dz dummy
scoreboard objectives add magnet_sq_dist dummy
