...
execute unless score %point ptracker_delay matches 9 positioned ~ -70 ~ if entity @e[type=armor_stand,tag=ptrackedO,distance=..0.4] run scoreboard players set %point ptracker_delay -1
execute if score %point ptracker_delay matches -1 run particle minecraft:dust 1 1 1 1.5 ^ ^ ^0.4 0 0 0 10 1 force @s
...
execute unless score %point ptracker_delay matches 0 positioned ^ ^ ^0.4 run function ptracker:scripts/point_o