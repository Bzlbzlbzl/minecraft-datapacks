...
execute as @a[tag=manhuntRunner,nbt={Dimension:"minecraft:overworld"},tag=!beenToOW,limit=1] at @s unless entity @e[tag=manhuntMarkerOW] run summon armor_stand ~ ~ ~ {Tags:["manhuntMarkerOW"],Marker:1b,Invisible:1b}
execute as @a[tag=manhuntRunner,nbt={Dimension:"minecraft:overworld"},tag=!beenToOW] run tag @s add beenToOW
execute as @a[tag=manhuntRunner,nbt={Dimension:"minecraft:the_nether"},tag=!beenToN,limit=1] at @s unless entity @e[tag=manhuntMarkerN] run summon armor_stand ~ ~ ~ {Tags:["manhuntMarkerN"],Marker:1b,Invisible:1b}
