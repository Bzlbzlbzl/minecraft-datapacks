...
execute if score %countdown death_swap matches 5999 as @r[gamemode=survival,scores={death_swap=-1}] run function death_swap:reset
...
execute unless score %countdown death_swap matches -1 as @a[scores={death_swap_died=1..}] as @r[gamemode=survival,scores={death_swap=-1}] run function death_swap:reset
...
execute if score %countdown death_swap matches 0 as @a[scores={death_swap=0}] run summon area_effect_cloud ~ ~ ~ {Tags:["swapMarker"]}
