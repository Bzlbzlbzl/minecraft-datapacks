...
execute if score @s rend matches 0 at @s run effect give @e[tag=hit] minecraft:blindness 7 1 true
execute if score @s rend matches 0 at @s run effect give @e[tag=hit] minecraft:slowness 6 1 true
execute if score @s rend matches 0 at @s run effect give @e[tag=hit] minecraft:weakness 6 9 true
...
execute if score @s rend matches 0 at @s positioned ~0.4 61.1 ~0.7 run scoreboard players set @e[type=minecraft:armor_stand,tag=reapScythe,limit=1,sort=nearest] calculation 220
...
execute if score @s rend matches 0 run scoreboard players set @s calculation 140
