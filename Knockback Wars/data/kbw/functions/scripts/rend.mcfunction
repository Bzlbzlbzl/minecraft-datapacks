...
execute if score @s rend matches 0 at @s run effect give @e[tag=hit] minecraft:blindness 9 1 true
execute if score @s rend matches 0 at @s run effect give @e[tag=hit] minecraft:slowness 8 1 true
execute if score @s rend matches 0 at @s run effect give @e[tag=hit] minecraft:weakness 8 9 true
...
execute if score @s rend matches 0 at @s positioned ~0.4 61.1 ~0.7 run scoreboard players set @e[type=minecraft:armor_stand,tag=reapScythe,limit=1,sort=nearest] calculation 300
