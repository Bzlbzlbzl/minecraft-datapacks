...
give @a[team=Archer,scores={queue=1}] splash_potion{display:{Name:'{"text":"Wind\'s Blessing","color":"aqua","italic":false}',Lore:['{"text":"A magical essence that"}','{"text":"allows you to nimbly"}','{"text":"outmaneuver your opponents."}']},HideFlags:0,CustomPotionEffects:[{Id:1,Amplifier:2b,Duration:180}],CustomPotionColor:2293580} 3
...
give @a[scores={queue=1},team=Assassin] splash_potion{display:{Name:'{"text":"Smoke Bomb","color":"yellow","italic":false}',Lore:['{"text":"Leaves your opponents in"}','{"text":"a murky cloud of smoke."}']},HideFlags:63,CustomPotionEffects:[{Id:9,Amplifier:2b,Duration:180},{Id:15,Amplifier:2b,Duration:120,ShowParticles:1b}],CustomPotionColor:0} 2
give @a[scores={queue=1},team=Assassin] ender_pearl{display:{Name:'{"text":"Ender Pearl","color":"yellow","italic":false}'},HideFlags:63} 6
give @a[scores={queue=1},team=Assassin] splash_potion{display:{Name:'{"text":"Cloak of Shadows","color":"yellow","italic":false}',Lore:['{"text":"A brew that helps you"}','{"text":"evade attacks unnoticed."}']},HideFlags:63,CustomPotionEffects:[{Id:8,Amplifier:9b,Duration:200,ShowParticles:0b},{Id:14,Amplifier:0b,Duration:200,ShowParticles:0b}],CustomPotionColor:2293580} 2
...
give @a[scores={queue=1},team=Witch] splash_potion{display:{Name:'{"text":"Potion of Nausea","color":"dark_purple","italic":false}',Lore:['{"text":"What is this disgusting"}','{"text":"liquid? It can\'t be healthy."}']},HideFlags:28,CustomPotionEffects:[{Id:9,Amplifier:0b,Duration:400}],CustomPotionColor:5578058} 2
give @a[scores={queue=1},team=Witch] splash_potion{display:{Name:'{"text":"Potion of Slowness","color":"dark_purple","italic":false}',Lore:['{"text":"Drains your limbs"}','{"text":"of all vigor."}']},HideFlags:28,CustomPotionEffects:[{Id:2,Amplifier:1b,Duration:600}],CustomPotionColor:5926017} 2
give @a[scores={queue=1},team=Witch] minecraft:splash_potion{display:{Name:'{"text":"Potion of Speed","color":"dark_purple","italic":false}',Lore:['{"text":"Charges your legs with"}','{"text":"a magical energy."}']},HideFlags:28,CustomPotionEffects:[{Id:1,Amplifier:2b,Duration:300}],CustomPotionColor:8171462} 1
give @a[scores={queue=1},team=Witch] splash_potion{display:{Name:'{"text":"Potion of Fear","color":"dark_purple","italic":false}',Lore:['{"text":"A strange potion that"}','{"text":"forces you to shake with"}','{"text":"a phantom dread."}']},HideFlags:28,CustomPotionEffects:[{Id:19,Amplifier:0b,Duration:2000}],CustomPotionColor:5797459} 1
