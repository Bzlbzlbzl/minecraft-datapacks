...
#Assassin
give @a[scores={queue=1},team=Assassin] stick{display:{Name:'{"text":"Dagger","color":"yellow","italic":false}',Lore:['{"text":"It seems pretty good"}','{"text":"for stabbing people."}']},HideFlags:60,Enchantments:[{id:"minecraft:knockback",lvl:2s}],AttributeModifiers:[{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:0.8,Operation:2,UUID:[I;-1247820005,1609059778,-2137617911,625810374],Slot:"mainhand"}]} 1
...
#Duelist
give @a[scores={queue=1},team=Duelist] iron_axe{display:{Name:'{"text":"Iron Axe","color":"red","italic":false}',Lore:['{"text":"All you need to survive"}','{"text":"is your trusty iron axe"}']},HideFlags:6,Unbreakable:1b,Damage:0,Enchantments:[{id:"minecraft:knockback",lvl:3s}],AttributeModifiers:[{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:1,Operation:0,UUID:[I;733622631,2085372670,-1122124795,-561594449]}],duelist:1b} 1
