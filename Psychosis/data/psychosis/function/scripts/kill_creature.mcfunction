...
execute if entity @s[type=wither_skeleton,tag=psyCreature] at @s run playsound minecraft:entity.creaking.sway ambient @a ~ ~ ~ 0.3 0

execute if entity @s[tag=psySounded,tag=psyCreature] at @s as @a[tag=psychosis] if score @s psy_id = @e[limit=1,sort=nearest,tag=psyCreature] psy_id run stopsound @s ambient minecraft:music_disc.13
execute if entity @s[tag=psySounded,tag=psyDying] at @s as @a[tag=psychosis] if score @s psy_id = @e[limit=1,sort=nearest,tag=psyDying] psy_id run stopsound @s ambient minecraft:music_disc.13
