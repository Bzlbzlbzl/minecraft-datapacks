...
execute as @a[scores={psy_death=1..,psychosis=72000..}] at @s as @e[tag=psyCreature] if score @s psy_id = @p psy_id run function psychosis:scripts/kill_creature
...
execute as @e[tag=psyCreature] at @s as @e[type=minecraft:player,gamemode=!spectator,distance=..8,scores={psychosis=72000..}] unless score @s psy_id = @e[limit=1,sort=nearest,tag=psyCreature] psy_id as @e[tag=psyCreature] if score @s psy_id = @e[limit=1,sort=nearest,tag=psyCreature] psy_id run function psychosis:scripts/kill_creature
execute as @e[tag=psyCreature] at @s as @e[type=minecraft:player,gamemode=!spectator,distance=..20,scores={psychosis=..71999}] unless score @s psy_id = @e[limit=1,sort=nearest,tag=psyCreature] psy_id as @e[tag=psyCreature] if score @s psy_id = @e[limit=1,sort=nearest,tag=psyCreature] psy_id run function psychosis:scripts/kill_creature
...
execute as @e[tag=psyCreature,type=minecraft:skeleton] run scoreboard players set @s psy_level 0
execute as @e[tag=psyCreature,type=minecraft:skeleton] at @s as @e[type=minecraft:player,gamemode=!spectator,distance=..150] if score @s psy_id = @e[limit=1,sort=nearest,tag=psyCreature,type=minecraft:skeleton] psy_id run scoreboard players set @e[limit=1,sort=nearest,tag=psyCreature,type=minecraft:skeleton] psy_level 1
execute as @e[tag=psyCreature,type=minecraft:skeleton,scores={psy_level=0}] at @s as @e[tag=psyCreature] if score @s psy_id = @e[tag=psyCreature,type=minecraft:skeleton,scores={psy_level=0},limit=1,sort=nearest] psy_id run function psychosis:scripts/kill_creature
# 
