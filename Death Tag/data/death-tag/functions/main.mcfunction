...
execute if score %starting death_tag matches 40 run tellraw @a ["",{"text":"Starting in ","color":"gold"},{"text":"2","bold":true,"color":"red"},{"text":"... ","color":"red"},{"text":"[","color":"dark_aqua","clickEvent":{"action":"run_command","value":"/execute unless score %timer death_tag matches 0.. run function death-tag:scripts/set_it"}},{"text":"Click Here","bold":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/execute unless score %timer death_tag matches 0.. run function death-tag:scripts/set_it"}},{"text":"]","bold":true,"color":"dark_aqua","clickEvent":{"action":"run_command","value":"/execute unless score %timer death_tag matches 0.. run function death-tag:scripts/set_it"}},{"text":" to be a tagger!","color":"gold"}]
execute if score %starting death_tag matches 20 run tellraw @a ["",{"text":"Starting in ","color":"gold"},{"text":"1","bold":true,"color":"red"},{"text":"... ","color":"red"},{"text":"[","color":"dark_aqua","clickEvent":{"action":"run_command","value":"/execute unless score %timer death_tag matches 0.. run function death-tag:scripts/set_it"}},{"text":"Click Here","bold":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/execute unless score %timer death_tag matches 0.. run function death-tag:scripts/set_it"}},{"text":"]","bold":true,"color":"dark_aqua","clickEvent":{"action":"run_command","value":"/execute unless score %timer death_tag matches 0.. run function death-tag:scripts/set_it"}},{"text":" to be a tagger!","color":"gold"}]
