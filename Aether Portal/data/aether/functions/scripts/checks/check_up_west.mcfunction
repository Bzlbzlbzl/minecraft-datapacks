#Checks up-west facing aether portal (by west facing I mean from the water block inside the aether portal facing the air inside the aether portal direction)
...
execute unless block ~1 ~-3 ~ glowstone run scoreboard players set @s aether_check 0
execute unless block ~ ~-3 ~ glowstone run scoreboard players set @s aether_check 0 
execute unless block ~-1 ~-3 ~ glowstone run scoreboard players set @s aether_check 0
execute unless block ~-2 ~-3 ~ glowstone run scoreboard players set @s aether_check 0
...
execute unless block ~-1 ~-2 ~ #aether:air_water run scoreboard players set @s aether_check 0
...
execute if entity @s[type=area_effect_cloud,tag=aetherPortal] unless block ~ ~-2 ~ water[level=0] run scoreboard players set @s aether_check 0
execute if entity @s[type=area_effect_cloud,tag=aetherPortal] unless block ~-1 ~-2 ~ water[level=0] run scoreboard players set @s aether_check 0
...
execute if score @s[tag=!aetherNorth,tag=!aetherSouth,tag=!aetherEast,tag=!aetherWest,tag=!aetherMidNorth,tag=!aetherMidSouth,tag=!aetherMidEast,tag=!aetherMidWest,tag=!aetherUpNorth,tag=!aetherUpSouth,tag=!aetherUpEast,tag=!aetherUpWest,type=area_effect_cloud] aether_check matches 1 run tag @s add aetherUpWest
