#Checks east facing aether portal (by east facing I mean from the water block inside the aether portal facing the air inside the aether portal direction)
...
execute if score @s[tag=!aetherNorth,tag=!aetherSouth,tag=!aetherEast,tag=!aetherWest,tag=!aetherMidNorth,tag=!aetherMidSouth,tag=!aetherMidEast,tag=!aetherMidWest,tag=!aetherUpNorth,tag=!aetherUpSouth,tag=!aetherUpEast,tag=!aetherUpWest,type=area_effect_cloud] aether_check matches 1 run tag @s add aetherEast
