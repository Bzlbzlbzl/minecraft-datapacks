...
function aether:scripts/checks/check_north
execute unless score @s aether_check matches 1 run function aether:scripts/checks/check_south
execute unless score @s aether_check matches 1 run function aether:scripts/checks/check_east
execute unless score @s aether_check matches 1 run function aether:scripts/checks/check_west

execute unless score @s aether_check matches 1 run function aether:scripts/checks/check_mid_north
execute unless score @s aether_check matches 1 run function aether:scripts/checks/check_mid_south
execute unless score @s aether_check matches 1 run function aether:scripts/checks/check_mid_east
execute unless score @s aether_check matches 1 run function aether:scripts/checks/check_mid_west

execute unless score @s aether_check matches 1 run function aether:scripts/checks/check_up_north
execute unless score @s aether_check matches 1 run function aether:scripts/checks/check_up_south
execute unless score @s aether_check matches 1 run function aether:scripts/checks/check_up_east
execute unless score @s aether_check matches 1 run function aether:scripts/checks/check_up_west
